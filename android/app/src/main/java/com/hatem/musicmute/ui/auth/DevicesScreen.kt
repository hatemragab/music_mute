...
internal fun DevicesScreen(
    ...
    AuthPage {
        ...
        Text(stringResource(R.string.auth_devices), style = MaterialTheme.typography.headlineLarge)
        ...
        state.devices.forEach { device ->
            Card(Modifier.fillMaxWidth().testTag("auth-device-${device.installationId}")) {
