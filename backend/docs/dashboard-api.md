...
| `POST /admin/releases/:id/uploads`                    | `bytes`, `sha256Hex`, `expectedRevision`, `operationId`                                                        | `{uploadId,grant:{url,fields,expiresAt},expectedBytes,expectedSha256}`                    | `releases.manage`        |
| `POST /admin/releases/:id/uploads/:uploadId/complete` | `operationId`                                                                                                  | `{artifactState,code?}`                                                                   | `releases.manage`        |
