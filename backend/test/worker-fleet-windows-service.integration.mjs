...
test(
  'installed Windows service completes a DirectML job through local API and real S3',
  { timeout: 20 * 60_000 },
  async () => {
    ...
    try {
      ...
      assert.match(
        child.output,
        /WORKER_FLEET_INTEGRATION_OK storage=s3 platform=windows-directml-service status=ready/,
      );
