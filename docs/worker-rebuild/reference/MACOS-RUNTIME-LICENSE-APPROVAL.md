...
| Enrollment/catalog    | <https://api.music-mute.com/worker/installations>                  | Authenticated metadata and short-lived exact-object grants; this is an API endpoint, not a large artifact download                      |
