...
| Processing detail | Waiting, uploading, queue, validation, processing, interruption, cancellation, retry, worker offline, failed/missing job and result retrieval; explicit loading/unavailable feedback and wrapping actions. |
