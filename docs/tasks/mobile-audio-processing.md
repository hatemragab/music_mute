...
- [x] A04 — Cloud history, detail and worker availability.
...
- [x] All ten states, personal-worker shutdown/recovery and cancellation acknowledgement are represented.
...
- [ ] Real S3 + deployed API + Z440 output validated separately when available.
