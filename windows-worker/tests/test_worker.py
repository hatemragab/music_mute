...
from musicmute_worker.worker import Cancelled, Journal, Lease, LeaseLost, Worker
...
class WorkerTests(unittest.TestCase):
    def setUp(self):
        ...
        self.separator.write_text(
            ...
            "p=argparse.ArgumentParser(); p.add_argument('input'); p.add_argument('--prepared', action='store_true'); p.add_argument('--output_dir'); a=p.parse_args()\n"
